...
with st.sidebar:
    ...
    st.page_link("frontend/pages/01_Explorer.py", label="🔍 Dataset Explorer", icon="🔍")
    st.page_link("frontend/pages/02_AI_Chat.py",  label="💬 AI Chat",          icon="💬")
    st.page_link("frontend/pages/03_Dashboard.py",label="📊 Dashboard",        icon="📊")
    st.page_link("frontend/pages/04_Reports.py",  label="📄 Reports",          icon="📄")
    st.markdown("---")
